...
def handle_channel_post_in_channel(message):
    """Handles the /channelpost command posted in a channel by an admin."""
    try:
        ...
        # Store channel info if not already saved
        ...
        bot.reply_to(message, f"✅ Link sent to the link channel!\n<a href='{deep_link}'>Click here</a> to view.",
                     parse_mode="HTML")
